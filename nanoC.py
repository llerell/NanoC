...
constantes: dict[tuple[str, str], str] = {}
...
def asm_expression(ast, env: dict[str, str]) -> tuple[str, str]:
    ...
    match ast.data:
        ...
        case "if":
            ...
            return f"""{test[1]}
                        ...
                        """
        case _:
            raise NotImplementedError(f"Commande non implémentée : {ast.data}")
